...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_jb4mkhz', 'template_c5a9qkt', formRef.current, 'gb7lMwwK0popUCyuH')
            .then((result) => {
                setSuccess(true)
